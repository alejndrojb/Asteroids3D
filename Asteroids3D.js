...
export class Asteroids3D extends Scene {
  constructor() {
    ...
    this.materials = {
      ...
      asteroid: new Material(new Textured_Phong(), {
        ambient: 1,
        diffusivity: 1,
        texture: new Texture("assets/asteroid.png"),
      }),

      asteroid_mat: new Material(new Jellyfish_Shader(), {
        ambient: 1,
        diffusivity: 1,
      }),
  ...
  animate_asteroids(context, program_state, dt, asteroids) {
    asteroids.forEach((asteroid) => {
      ...
      this.shapes.asteroid_rock.draw(context, program_state, asteroid.transform, this.materials.asteroid);
    });
  }
  ...
  draw_sun(context, program_state) {
    ...
    const light_position = vec4(0, -2, 0, 1); // center the point light source to center of the coordinate planes
    ...
    this.shapes.sphere4.draw(context, program_state, model_transform, this.materials.sun);
